...
public class ConsoleRemoveLaunchAction extends Action
	...
	protected ILaunch getLaunch() {
		...
		// else get dynmically, as this action was created via plug-in XML view
		// contribution
		IConsole console = fConsoleView.getConsole();
		if (console instanceof ScriptDebugConsole) {
			ScriptDebugConsole pconsole = (ScriptDebugConsole) console;
			return pconsole.getLaunch();
		}
		return null;
	}
}
