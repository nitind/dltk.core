...
public class DLTKSearchTableContentProvider extends DLTKSearchContentProvider
	...
	public void elementsChanged(Object[] updatedElements) {
		...
		viewer.update(updated.toArray(),
				new String[] { SearchLabelProvider.PROPERTY_MATCH_COUNT });
