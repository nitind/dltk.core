...
public abstract class SelectionDispatchAction extends Action
	 ...
	 *                     the site this action is working on
	 * @param provider
	 *                     a special selection provider which is used instead of
	 *                     the site's selection provider or <code>null</code> to
	 *                     use the site's selection provider. Clients can for
	 *                     example use a {@link ConvertingSelectionProvider} to
	 *                     first convert a selection before passing it to the
	 *                     action.
	 *
	 *
